...
// Watch for task changes OR create mode
watch(() => [props.task, props.show], ([newTask, showing]) => {
    if (newTask) {
...
// Create new task (for create mode)
const createTask = () => {
...
<template>
    ...
    >
        <div v-if="show" class="fixed inset-0 bg-black/30 z-40" @click="$emit('close')"></div>
    </Transition>
    ...
    >
        <div v-if="show" class="fixed inset-y-0 right-0 w-full max-w-lg bg-white shadow-2xl z-50 flex flex-col">
            ...
            <div class="flex items-center justify-between px-5 py-4 border-b border-gray-100">
                <div class="flex items-center gap-3">
                    ...
                    <template v-if="isCreateMode">
                        <PlusIcon class="h-7 w-7 text-brand" />
                ...
                <div class="flex items-center gap-2">
                    <button v-if="!isCreateMode" @click="deleteTask" class="p-2 text-gray-400 hover:text-red-500 rounded-lg hover:bg-gray-50">
                        <TrashIcon class="h-5 w-5" />
                    </button>
                    <button @click="$emit('close')" class="p-2 text-gray-400 hover:text-gray-600 rounded-lg hover:bg-gray-50">
                ...
                <div class="p-5 space-y-5">
                    ...
                    <div class="flex flex-wrap gap-3">
                        ...
                        <div class="flex items-center gap-2 bg-gray-50 rounded-lg px-3 py-2">
                            ...
                            />
                            <span v-if="!form.due_date" class="text-sm text-gray-400">Sin fecha</span>
                        </div>

                        <!-- Priority -->
                        <Dropdown align="left" width="48">
                            <template #trigger>
                                <button class="flex items-center gap-2 bg-gray-50 rounded-lg px-3 py-2 hover:bg-gray-100 transition-colors w-full sm:w-auto justify-between sm:justify-start group">
                        ...
                        <!-- Has Subtasks Toggle -->
                        <label class="flex items-center gap-2 bg-gray-50 rounded-lg px-3 py-2 cursor-pointer">
                            <input 
                                type="checkbox" 
                    ...
                    <div v-if="form.has_subtasks" class="space-y-3">
                        ...
                        <div class="space-y-1">
                            <div 
                                ...
                                :key="subtask.id" 
                                class="flex items-center gap-2 py-2 px-2 rounded-lg hover:bg-gray-50 group"
                            >
                                ...
                                <template v-else>
                                    <span :class="['text-sm flex-1', subtask.is_completed ? 'text-gray-400 line-through' : 'text-gray-700']">
                                        {{ subtask.name }}
                                    </span>
            ...
            <div class="px-5 py-3 border-t border-gray-100 bg-gray-50">
                ...
                <template v-if="isCreateMode">
                    <button 
                        ...
                        class="w-full py-2.5 px-4 bg-brand text-white rounded-lg font-medium hover:bg-brand/90 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                    >
                        Crear Tarea
                    </button>
                </template>
